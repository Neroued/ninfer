...
// Pure (CUDA-free, Engine-free) support logic for the ninfer_bench throughput tool:
...
// ninfer_bench.cpp; everything here is host-only and unit-testable without a GPU.
...
// Small shared helpers (also used by ninfer_bench.cpp for the report header).

...
>
> 实现状态（2026-07-12）：本文描述的 C++ Vision tower、multimodal prefill、MRoPE/decode
> 延续、CLI 和服务接入均已完成。最终契约与验证证据见
> [Qwen3.6 Vision Engine Integration](2026-07-12-qwen3-6-vision-engine-integration.md)。

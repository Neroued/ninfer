...
> 状态：详细设计与 dormant candidate 已实现；production 尚未切换，route 资格实验进行中。
>
...
|---|---|
| `GemvR4W1Shared` | R4/W1/G16/S1，runtime groups，`CtaSharedFullK`，PackedWord8/Fp16Mantissa，code AsyncVector16 `Ca`，scale SharedPair32，launch-bounds min blocks 1 |
...
```text
q4.gemv.r4.w1.g16.s1.groups_runtime.x_shared_full_k.lane_q4x8.decode_fp16mantissa.code_async_vec16_ca.scale_shared_pair32.lb1

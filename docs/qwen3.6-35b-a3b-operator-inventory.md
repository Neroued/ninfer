...
| **Adapt existing** | Every target-callable dense/quantized Linear domain plus private L15-L17; indexing and scalar transforms; pointwise domains other than E1/E6. All remain unsupported. |

...
| `request_done` | finish reason, prompt/completion/cache/computed-prefill tokens, prefix reuse path, selected execution lane, unrounded phase seconds, and complete speculative-decoding counters |

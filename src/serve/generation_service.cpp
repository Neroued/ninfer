...
public:
    ServiceOutputSink(const StreamSink& sink, bool filter_tool_calls, bool hold_reasoning)
        : sink_(&sink), filter_tool_calls_(filter_tool_calls), hold_reasoning_(hold_reasoning) {}

...
// client/default upper bound. Capacity fitting belongs to Engine and is reported
// by the final finish reason. `client_set` distinguishes a client-provided value
// from the server default; `sampling` is the resolved public sampler config.

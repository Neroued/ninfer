#include "targets/qwen3_6_27b_rtx5090/impl/kernels/mtp/round_launch.h"

#include "kernels/common/math.h"
#include "targets/qwen3_6_27b_rtx5090/impl/kernels/mtp/round.cuh"
...
void mtp_accept_tokens_launch(const Tensor& target_tokens, const Tensor& logits,
    ...
    mtp_sampling_group_finalize_kernel<<<group_grid, kSamplerBlock, 0, stream>>>(
        ...
        token_domain, cols, partial_blocks, groups);
    CUDA_CHECK(cudaGetLastError());
}

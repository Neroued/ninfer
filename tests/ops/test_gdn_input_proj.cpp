...
int run_fp8() {
    ...
    // 1153, 4096 and 4160 reach the TMA-staged route; below them it declines, so without them
    // this op output type never runs there. 1153 and 4160 leave a partial trailing tile, and

...
S expected_schedule(const W8Problem& problem) {
    ...
    if (problem.rows == 4608 || (problem.rows == 5120 && problem.k == 4608)) {
        if (problem.cols <= 4) { return S::SimtR8C4; }
...
void route_boundaries() {
    constexpr std::array<W8Problem, 37> cases{{
        ...
        {5120, 17408, 17408, 17},      {4608, 4608, 4608, 1},    {4608, 4608, 4608, 4},
        {4608, 4608, 4608, 5},         {4608, 4608, 4608, 6},    {4608, 4608, 4608, 128},

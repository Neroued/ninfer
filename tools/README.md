...
`convert/common/` owns shared safetensors and quantization helpers. The target converter owns the
exact checkpoint inventory, source recipe, draft-head construction, and source verifier.
